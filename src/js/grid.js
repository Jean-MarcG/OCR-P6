class Grid {
    ...
    displayPlayersInfo() {
        ...
        for (let j = 0; j < this.players.length; j++) {
            ...
            aside.innerHTML = `<div class="info-wrapper">
                <div class="info-wrapper__header">
                ...
                <div class="info-wrapper__footer player-buttons">
                    <button class="attack big-button">Attaquer</button>
                    <button class="defend big-button">Défendre</button>
                </div>
            </div>`;
            c.appendChild(aside);
    ...
    activePlayerButtonAction(){
        const otherPlayerIndex = this.activePlayerIndex === 0 ? 1 : 0;
        const otherPlayerAside = $('.content__item--players aside').eq(otherPlayerIndex);
        otherPlayerAside.find(".player-buttons").hide();
        console.log(otherPlayerAside);

        const playerAside = $('.content__item--players aside').eq(this.activePlayerIndex);
        playerAside.find(".player-buttons").show();
    }
